                    ...
                    <div className="col-6 d-flex flex-column justify-content-center">
                        <div className='d-flex justify-content-end'>
                            {menuItems.map((item, index) => (
                                ...
                                >
                                    <Link to={''} className={`btn ${style.footermenubtn}`}>{item}</Link>
                                </motion.div>
                            ))}
                        </div>
                        <div className='d-flex gap-3 justify-content-end mt-3 align-items-center'>
                            ...
                            <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>                           <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
