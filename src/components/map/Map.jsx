                            ...
                            >
                                <defs>
                                    <radialGradient id="grad" cx="50%" cy="50%" r="50%" fx="50%" fy="50%">
                                        ...
                                        <stop offset="30%" style={{ stopColor: '#FCFCFC' }} />
                                        <stop offset="49.2%" style={{ stopColor: '#F3F3F3' }} />
                                        <stop offset="65.8%" style={{ stopColor: '#E4E4E4' }} />
                                        <stop offset="80.7%" style={{ stopColor: '#CFCFCF' }} />
                                        <stop offset="94.5%" style={{ stopColor: '#B4B4B4' }} />
                                        <stop offset="100%" style={{ stopColor: '#A7A7A7' }} />
                                    </radialGradient>
                                </defs>
                                <motion.path
                                    fill='url(#grad)'
